...
CREATE TABLE `ws_p40_sponsors` (
  ...
  `info_uk` text COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `banner_white` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `banner_small_white` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
